<template>
  <div class="app-container calendar-list-container page-content">
    <div class="Sharing_head">
      ...
      <div id="top_menu">
	      <h2 class="">{{$t('Warehouse.WarehouseList')}}</h2>
        <div class="order_list_menu ">
          <div class="pull-right order_list_top">              
              <button class="btn btn-primary btn-lg btn-primary-pd" data-toggle="modal" @click="handleAddWarehouse()">{{$t('Warehouse.NewWarehouse')}}</button>
              <button class="btn btn-primary btn-lg btn-primary-pd" data-toggle="modal" @click="handleEditWarehouse()">{{$t('Warehouse.Modifythewarehouse')}}</button>
              <button class="btn btn-primary btn-lg btn-primary-pd" data-toggle="modal" @click="handleEnable()">{{$t('Warehouse.Enabled')}}</button>
              <button class="btn btn-primary btn-lg btn-primary-pd" data-toggle="modal" @click="handleDisable()">{{$t('Warehouse.Disabled')}}</button>
            </div>
        </div>
	    </div>
    ...
    <el-table ref="orderTable" :data="list" v-loading.body="listLoading" border fit highlight-current-row style="margin-top:5px;width: 100%" @sort-change="handTableSort" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" :label="$t('order.address')" min-width = "14%">
        <template scope="scope">
          <span>{{scope.row.address}}</span>
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('Warehouse.status')" prop="createDate" min-width = "9%">
        <template scope="scope">
            ...
            <div class="order_detection main_form_input">
              ...
              <form role="form" ref="orderForm">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" id="" alt='verifyWarehouseForm' placeholder="" type="text" v-model="warehouse.enname">
                </div>
                <div class="form-group col-md-6">
                  <label for="">{{$t('Warehouse.Chinesename')}}</label>
                  <input class="form-control" alt='verifyWarehouseForm' id="" placeholder="" type="text" v-model="warehouse.cnname">
                </div>
                <div class="form-group col-md-6">
                  <label for="">{{$t('order.country')}}</label>
                  <el-select v-model="warehouse.country" id="country" filterable :placeholder="$t('order.choose')" size="small" class="select_list form-control" @change="countyChange">
                ...
                <div class="form-group col-md-6">
                  ...
                  <el-autocomplete v-model="warehouse.city" id="city" :fetch-suggestions="querySearchCity" class="select_list form-control"></el-autocomplete>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" alt='verifyWarehouseForm' id="" placeholder="" type="text" v-model="warehouse.phone">
                </div>
                <div class="form-group col-md-6">
                  <label for="">{{$t('Warehouse.Overallintroduction')}}</label>
                  <input class="form-control" alt='verifyWarehouseForm' id="" placeholder="" type="text" v-model="warehouse.content">
                </div>
                <div class="form-group col-md-6">
                  <label for="">{{$t('Warehouse.SystemCODE')}}</label>
                  <input class="form-control" alt='verifyWarehouseForm' id="" placeholder="" type="text" v-model="warehouse.syscode">
                </div>
                <div class="form-group col-md-12">
                  <label for="">{{$t('order.address')}}</label>
                  <input class="form-control" alt='verifyWarehouseForm' id="" placeholder="" type="text" v-model="warehouse.address">
                </div>
                <div class="form-group col-md-12">
                  <label for="">{{$t('order.Detail.Note')}}</label>
                  <el-input type="textarea" alt='verifyWarehouseForm' id="remark" :rows="3" v-model="warehouse.remark"></el-input>
                </div>
              </form>
              </div>
            </div>
...
<script>
  ...
  methods: {
    ...
    handleAddWarehouse(){
      this.title = this.$t('Warehouse.NewWarehouse');
    ...
    handleEditWarehouse(){
        ...
        this.title = this.$t('Warehouse.Modifythewarehouse');
