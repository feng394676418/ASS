...
<div class="app-container calendar-list-container page-content">
  <div class="Sharing_head">
    ...
    <div id="top_menu">
	            ...
	            <div class="order_list_menu ">
	            	<div class="pull-right order_list_top">
                        <form>	                 
                            <el-select clearable v-model="listQuery.searchValue" :placeholder="$t('inventory.provider')" @change="handlesearchByOwner" size="small">
                                <el-option
                            ...
                            <el-select clearable v-model="listQuery.productType"  :placeholder="$t('stockOrder.productType')" @change="handlesearchByProviderCode" size="small">
                                <el-option
    ...
    <el-table ref="partInventoryTable"  :data="list" v-loading.body="listLoading"  style="margin-top:5px;width: 100%" @sort-change="handTableSort" @selection-change="handleSelectionChange">
      ...
      <el-table-column  min-width="10%" align="center" :label="$t('stockOrder.odrNumber')">
        <template scope="scope">
          <span>{{scope.row.odrNumber}}</span>
        </template>
      </el-table-column>
      <el-table-column  min-width="10%" align="center" :label="$t('inventory.provider')">
        <template scope="scope">
    ...
    data() {
     ...
     beforeCreate(){
        ...
        Vue.filter('productTypeFilter', function(val) {
              var productTypeName  = '';
              console.dir(_this.productTypeOptions);
