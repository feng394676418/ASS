...
<div class="app-container calendar-list-container page-content">
    <div id="top_menu">
	            <h2 class="">{{inventoryChangeTitle+" : "+listQuery.owner+" "+inventoryTypeName}}  </h2>
...
export default {
    ...
    data() {
      ...
      ids :'',
      partChanges : [],
      inventoryTypeOptions :this.$t('stockOrder.productTypeOptions'),
      providerType :'',
      inventoryTypeName : '',
      providerOptions: []
    }
    ...
    created() {
        ...
        _this.inventoryTypeOptions.map(function (item) {
                  if(item.value == _this.listQuery.inventoryType){
                      _this.inventoryTypeName =  item.label;
                  }
    　 })
    },
    methods: {
      ...
      handleReturnList(){
         this.$router.push({ path: '/partInventory/manufacturer/index' });
      }
    }
}
