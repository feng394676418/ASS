...
<div class="app-container calendar-list-container page-content">
  <div class="Sharing_head">
    ...
    <div id="top_menu">
	            ...
	            <div class="order_list_menu ">
	            	<div class="pull-right order_list_top">
                        <form>	                 
                            <el-select clearable v-model="listQuery.searchValue" placeholder="" @change="handlesearchByProviderCode" size="small">
                                <el-option
                            ...
                            <el-select clearable v-model="listQuery.inventoryType"  placeholder="" @change="handlesearchByInventoryType" size="small">
                                <el-option
    ...
    <el-table ref="partInventoryTable"  :data="list" v-loading.body="listLoading"  style="margin-top:5px;width: 100%" @sort-change="handTableSort" @selection-change="handleSelectionChange">
      ...
      <el-table-column min-width="15%" align="center" :label="$t('inventory.name')">
        <template scope="scope">
          <span>{{scope.row.cnName}}</span>
        </template>
      </el-table-column>

      <el-table-column min-width="15%" align="center" :label="$t('inventory.unit')">
        <template scope="scope">
...
export default {
    ...
    data() {
      ...
      ids :'',
      inventoryTypeOptions :this.$t('inventory.inventoryTypeOptions'),
      providerType :'',
      providerOptions: [],
      ownerOptions : []
    }
    ...
    methods: {
        ...
        handlesearchByProviderCode(val){
          this.listQuery.searchValue = val;
          this.getList();
        },
        ...
        handleViewInventoryChange(sku,providerCode,owner,inventoryType){
            ...
            this.$router.push({ path: '/partInventory/provider/change/index/'+sku+"/"+owner+"/"+providerCode+"/"+inventoryType });
        },
        getProviderList(){
             const providerQuery = {};
