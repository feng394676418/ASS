        ...
        <div class="order_detection main_form_input">
          ...
          <div class="panel-body">            
              <div class="form-group col-md-6">
                ...
                <input class="form-control" id="" :placeholder="baseInfo.emergencyName" type="text" v-model="acceptForm.emergencyName"></input>
              </div>
              <div class="form-group col-md-6">
                <label for="">{{$t('order.Alternativecontacttel')}}</label>
                <input class="form-control" id="" :placeholder="baseInfo.emergencyPhone" type="text" v-model="acceptForm.emergencyPhone" />
              </div>
          </div>
          <div class="panel-body">            
              <div class="col-md-6">
          ...
          <div class="panel-body">      
              ...
              <div class="form-group col-md-6">
                ...
                <input class="form-control" :v-model="acceptForm.color" id="" placeholder="" type="text">
              </div>
              <div class="form-group col-md-6">
                <label for="">{{$t('order.Appearance')}} </label>
                    <el-select class="select_list default form-control" v-model="acceptForm.appearance" clearable :placeholder="$t('order.choose')">
                      <el-option
              ...
              <div class="form-group col-md-6">
                ...
                <input class="form-control" v-model="acceptForm.appearanceInfo" id="" placeholder="" type="text">
              </div>               
              <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-6">
                ...
                <input class="form-control" id="" v-model="acceptForm.partsOther" placeholder="" type="text">
              </div>        	
              <div class="clearfix"></div>
