...
export default {
    order: {
        ...
        Detail: {
            ...
            worryaboutyourIQ: '该备件已存在，如需追加请调整数量!',
            Accessoriesadded: '选中的配件已追加,请先删除!',
    ...
    part: {
        ...
        Reviewapplication: '审核服务商备件申请',
        Notthroughreason: '不通过原因',
        examinationpassed: '审核通过',
        Auditnotpassed: '审核不通过',
        whyauditnotpass: '请输入审核不通过原因!',
        Successfulprocessing: '处理结果更新成功!',
        addPartOK: '新增备件成功！',
        addPartNG: '新增备件失败！',
        editPartOK: '修改备件成功！',
        editPartNG: '修改备件失败！',
    ...
    Passwordinconsistent: '两次输入的新密码不一致!',
